...
public class BekannteRollenIdValidator implements ConstraintValidator<BekannteRollenId, String> {

    @Autowired
    private RollenDao rollenDao;

    @Override
    public void initialize(BekannteRollenId constraintAnnotation) {
    }
