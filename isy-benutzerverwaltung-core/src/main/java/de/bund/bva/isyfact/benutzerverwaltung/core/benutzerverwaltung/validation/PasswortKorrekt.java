...
@Documented
@Constraint(validatedBy = PasswortKorrektValidator.class)
@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE })
@Retention(RUNTIME)
public @interface PasswortKorrekt {

    String message() default "{" + ValidierungSchluessel.MSG_PASSWORT_AENDERN_FALSCH + "}";
