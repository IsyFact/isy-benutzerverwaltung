...
public class SelfServicePasswortAnfordernController
    extends AbstractSelfServiceController<SelfServicePasswortAnfordernModel> {

    public SelfServicePasswortAnfordernController(MessageController messageController, MessageSource messageSource,
    ...
    public void passwortAnfordern(SelfServicePasswortAnfordernModel selfServicePasswortAnfordernModel) {
        try {
            getAwkWrapper().sendePasswortZuruecksetzenEmail(selfServicePasswortAnfordernModel.getEmail());
            ...
            getMessageController().writeInfoMessage(
                    MessageSourceHolder.getMessage(
                            "MEL_Selfservice_PasswortMailAngefordert",
