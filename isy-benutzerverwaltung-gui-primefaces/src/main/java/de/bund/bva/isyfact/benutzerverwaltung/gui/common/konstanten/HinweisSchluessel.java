...
public abstract class HinweisSchluessel {
    ...
    /**
     * Die Rolle '{0}' wurde erfolgreich gelöscht.
     */
    public static final String ROLLE_GELOESCHT = "BENVW80013";

    /**
     * Die Rolle '{0}' wird noch verwendet und kann daher nicht gelöscht werden.
     */
    public static final String ROLLE_LOESCHEN_VERWENDET = "BENVW080014";
