...
public abstract class AbstractSicherheitTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    protected Benutzer erzeugeBenutzerInDb(String benutzername, String passwort, String emailAdresse,
        BenutzerStatus status, Date letzteAnmeldung, String... rollen) {
        ...
        benutzer.setLetzteAnmeldung(letzteAnmeldung);
