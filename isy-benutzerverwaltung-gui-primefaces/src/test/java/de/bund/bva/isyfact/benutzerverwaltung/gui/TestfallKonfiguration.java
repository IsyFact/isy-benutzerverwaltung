...
@ImportResource(
    { "classpath:resources/isy-benutzerverwaltung/spring/isy-benutzerverwaltung-gui-primefaces-modul.xml",
...
public class TestfallKonfiguration {
    ...
    public Konfiguration konfiguration() {
        String[] konfigurationsDateien = { "/config/isy-benutzerverwaltung.properties",
            "/resources/isy-benutzerverwaltung/nachrichten/gui-linksnavigation.properties" };
