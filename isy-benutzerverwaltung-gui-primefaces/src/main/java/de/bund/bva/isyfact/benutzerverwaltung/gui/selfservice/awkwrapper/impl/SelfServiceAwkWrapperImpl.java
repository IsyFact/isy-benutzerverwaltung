...
public class SelfServiceAwkWrapperImpl implements SelfServiceAwkWrapper {
    ...
    public SelfServiceAwkWrapperImpl(
    ...
    @Override
    public BenutzerModel passwortZuruecksetzen(PasswortZuruecksetzenDaten daten) throws BenutzerverwaltungBusinessException {
