 ...
 */
public class RollenZuweisungModel
    extends AbstractSuchDataTableModel<BenutzerModel, BenutzerSuchkriterienModel> {
    ...
    /**
     * @param rollenZuordnung the rollenZuordnung to set
     */
    ...
    /**
     * @param rollenIdZurZuweisung the rollenIdZurZuweisung to set
     */
